...
Debido a que nuestro interés reside en adquirir los datos mensuales de cada cultivo desde el 2020 hasta el presente año, el siguiente paso fue repetir este proceso iterando de manera anidada sobre los ID's de los años, meses y cultivos de nuestro interés. En cada iteración, el contenido de la tabla referente a un cultivo en un mes de un año particular, fue almacenado en un archivo CSV local cuyo nombre sigue el formato: "cultivo_mes_año.csv". En total, al tratarse de 4 años, 12 meses y 64 cultivos, se obtuvo un apróximado de 3072 (en realidad son menos porque el 2023 está incompleto). 
